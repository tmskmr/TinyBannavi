...
public class PlugIn_RecRD_MAIL_RE2 extends PlugIn_RecRD_MAIL_Z9500 implements HDDRecorder,Cloneable {

	public PlugIn_RecRD_MAIL_RE2 clone() {
		return (PlugIn_RecRD_MAIL_RE2) super.clone();
	}

	@Override
	public String getRecorderId() { return "REGZA RE2(Mail)"; }

	@Override
	protected String getDefFile() { return "env/mail_re2.def"; }
