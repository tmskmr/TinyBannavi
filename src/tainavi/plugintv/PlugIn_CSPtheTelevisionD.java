...
public class PlugIn_CSPtheTelevisionD extends PlugIn_TVPtheTelevision implements TVProgram,Cloneable {
	...
	// 種族の特性
	@Override
	public String getTVProgramId() { return "webザテレビジョン(CSデジ)"; }
	...
	//
	public PlugIn_CSPtheTelevisionD clone() {
		return (PlugIn_CSPtheTelevisionD) super.clone();
	}
	...
	public void loadCenter(String code, boolean force) {
		...
		String url = "http://www.television.co.jp/digitalguide/guide.php?type=cs&page=1";
		if ( _loadCenter(newcrlist, code,"csd",url) ) {
